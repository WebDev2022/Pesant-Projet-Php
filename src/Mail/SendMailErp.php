...
class SendMailErp
{
    ...
    public function send_email()
    {
        ...
        try {
            ...
            $mail->addAddress($_ENV['MAIL_ERP'], 'ERP-APPLICATION');
            ...
            */
            ...
            if(FileUpload::upload_files_exist($this->files)) {
                ...
                foreach($this->files['files']['name'] as $key => $file_name) {
                    ...
                    $path_file = dirname(__DIR__). DIRECTORY_SEPARATOR . 'backupMailFiles/'.$this->name.'-('.$date.')/'.$file_name;

                    $path_dir = dirname(__DIR__). DIRECTORY_SEPARATOR . 'backupMailFiles/'.$this->name.'-('.$date.')/';
